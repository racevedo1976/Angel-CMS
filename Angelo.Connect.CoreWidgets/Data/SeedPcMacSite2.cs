...
{
    public class SeedPcMacSite2 : IPluginStartupAction
    {
        ...
        public void Invoke()
        {
            var siteId = HtmlDbSeedConstants.SiteId_PcMac2;
            var primaryMasterPageId = HtmlDbSeedConstants.MasterId_PcMac2_Primary;
            var secondaryMasterPageId = HtmlDbSeedConstants.MasterId_PcMac2_Secondary;
            var homePageId = HtmlDbSeedConstants.PageId_PcMac2_Home;
