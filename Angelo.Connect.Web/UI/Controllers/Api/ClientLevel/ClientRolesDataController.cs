...
{
    public class ClientRolesDataController : ClientControllerBase
    {
        ...
        [HttpPost("/sys/clients/{tenant}/api/roles/data")]
        ...
        [Authorize(policy: PolicyNames.ClientRolesCreate)]
        [HttpPost("/sys/clients/{tenant}/api/roles")]
        ...
        [Authorize(policy: PolicyNames.ClientRolesEdit)]
        [HttpPut("/sys/clients/{tenant}/api/roles/{roleId}")]
        ...
        [Authorize(policy: PolicyNames.ClientRolesDelete)]
        [HttpDelete, Route("/sys/clients/{tenant}/api/roles/{roleId}")]
        ...
        [Authorize(policy: PolicyNames.ClientRolesEdit)]
        [HttpPost("/sys/clients/{tenant}/api/roles/{roleId}/permissions/add")]
        ...
        [Authorize(policy: PolicyNames.ClientRolesEdit)]
        [HttpPost("/sys/clients/{tenant}/api/roles/{roleId}/permissions/remove")]
        ...
        [Authorize(policy: PolicyNames.ClientRolesEdit)]
        [HttpPost("/sys/clients/{tenant}/api/roles/{roleId}/permissions")]
