...
{
    public class UserGroupMemberEdit : ViewComponent
    {
        private UserGroupManager _userGroupManager;
        private UserManager _userManager;
        private EnumLocalizer _enumLocalizer;

        public UserGroupMemberEdit(UserGroupManager userGroupManager, UserManager userManager, EnumLocalizer enumLocalizer)
        {
