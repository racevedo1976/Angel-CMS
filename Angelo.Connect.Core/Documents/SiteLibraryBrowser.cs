...
{
    public class SiteLibraryBrowser : IContentBrowser
    {
        private IFolderManager<FileDocument> _folderManager;
        private string iconClassForDisplay = "fa fa-folder";
        private string _contentBrowserType = typeof(SiteLibraryBrowser).Name;
        private string _componentViewName = "FileDetails";
        private string _rootFolderName = "Site Library";
        ...
        private bool ResolveAuthorization(string[] claimTypes)
        {
            ...
            {
                    new Claim(type, _adminContext?.SiteId),
            ...
            return _adminContext.UserContext.SecurityClaims.Any(
