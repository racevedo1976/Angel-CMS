...
{
    public class LibraryEditFilesRequirement : IAuthorizationRequirement
    {
    }

    public class LibraryEditFilesHandler : AbstractCorpLevelClaimHandler<LibraryEditFilesRequirement>
    {
