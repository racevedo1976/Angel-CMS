...
namespace Angelo.Common.Mvc.Saas.Middleware
{
    public class TenantPipelineMiddleware<TTenant>
    {
        ...
        public TenantPipelineMiddleware( RequestDelegate next,  IApplicationBuilder rootApp, Action<TenantPipelineBuilderContext<TTenant>, IApplicationBuilder> configuration)
        {
