    ...
    public class ThumbnailProvider
    {
        ...
        public static Bitmap GetThumbnail(string fileName, int width, int height, ThumbnailOptions options)
        {
            ...
            try
            {
                ...
                return GetBitmapFromHBitmap(hBitmap, width, height);
            }
            finally
            {
        ...
        public static Bitmap GetBitmapFromHBitmap(IntPtr nativeHBitmap, int width, int height)
        {
            ...
            return CreateAlphaBitmap(bmp, PixelFormat.Format32bppArgb, width, height);
        }

        public static unsafe Bitmap CreateAlphaBitmap(Bitmap srcBitmap, PixelFormat targetPixelFormat, int width, int height)
        {
            ...
            try
            {
                height = height <= srcData.Height ? height : srcData.Height;
